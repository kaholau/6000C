...
class Image(QLabel):
	...
	def mouseReleaseCallback(self,x,y):
		...
		self.last_min_path_len = len(self.temp_min_path)
	...
	def getClosedCoutour(self):
		#TODO return min_path from last seed to the first seed

		return

	def undo(self):
		#TODO remove the min_path generated by last seed
		self.min_path = self.min_path[:-self.last_min_path_len]
		return self.min_path
